    ...
    <table class="form-table">
        <tbody>
            ...
            <tr>
                <th scope="row"></th>
                <td>
                    <label><input type="checkbox" name="wppusher[private]" <?php if (isset($_POST['wppusher']['private'])) echo 'checked'; ?> <?php echo ($data['hasValidLicense']) ? null : 'disabled'; ?>> Repository is private</label>
                    <?php if ( ! $data['hasValidLicense']) { ?>
